      ...
      <div className="">
        ...
        <section className="relative bg-secondary py-20 mb-20">
          ...
          <div className="relative container mx-auto px-4 text-center">
            ...
            <Link
              href="/shop"
              className="bg-secondary text-white py-2 px-6 rounded-md text-lg font-semibold hover:bg-gray-800 transition"
            >
              Shop Now
            </Link>
          </div>
        ...
        <div className="px-24">
          ...
          <section className="bg-gray-100 py-20">
            <div className="container mx-auto px-4 text-center">
              <h2 className="text-3xl font-bold text-black-1 mb-8">
                Shop by Category
              </h2>
